const Creative = ({ data }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-white dark:bg-gray-800 shadow-lg transition-colors duration-200">
      {/* Header */}
      <header className="bg-primary dark:bg-primary-dark text-white p-8">
      ...
      <div className="p-8">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary dark:text-primary-dark mb-4">About Me</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{summary}</p>
        </section>

        {/* Experience */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary dark:text-primary-dark mb-4">Experience</h2>
        ...
        {/* Education */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary dark:text-primary-dark mb-4">Education</h2>
        ...
        {/* Skills */}
        <section>
          <h2 className="text-2xl font-bold text-primary dark:text-primary-dark mb-4">Skills</h2>
